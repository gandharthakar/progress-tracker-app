const fgtPwdEmailTemplate = (link) => {
    return `
...
<head>
    ...
    <title>Forgot Password | Progress Tracker App.</title>
    <style>
        * {
            margin: 0px;
            padding: 0px;
                                    ...
                                    <tr>
                                        <td style="padding:0px 20px 10px 20px;">
                                            <p style="color: #27272a; font-weight: 400; font-size: 14px;">
                                                Below is you password reset link. Link is valid only for 5 minutes.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 10px 20px 10px 20px; text-align: center;">
                                            <a href="${link}" title="Reset Password"
                                                style="display: inline-block; padding: 8px 20px; background-color: #09090b; color: #fafafa; text-decoration: none; min-width: 100px; text-align: center;">
                                                Reset Password
                                            </a>
                                        </td>
                                    </tr>
...
module.exports = fgtPwdEmailTemplate;